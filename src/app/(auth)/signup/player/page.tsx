...
export default function PlayerSignupPage() {
  ...
  return (
    <div className="card p-8">
      ...
      {/* Google sign-up: the fast path for players. Auto-creates a Player
          profile linked to the Google account on first sign-in. */}
      <button
        type="button"
        onClick={() => signIn("google", { callbackUrl: "/me?welcome=1" })}
